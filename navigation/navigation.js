...
function toggleShowMore() {
    const content = document.getElementById("showMoreContent");
    const icon = document.querySelector("#showMoreToggle img");
...
function showEnterprisePopup(featureName) {
    Swal.fire({
        icon: "error",
        title: "Oops...",
        html: `<strong>${featureName}</strong> is available in the <strong>Enterprise Plan</strong> only.    <br>    Subscribe to unlock this feature!`
    });
}